...
/**
 * Criteria class for the {@link com.elysium.metagods.domain.God} entity. This class is used
 * to receive all the possible filtering options from
 * the Http GET request parameters.
 * For example the following could be a valid request:
 * {@code /gods?id.greaterThan=5&attr1.contains=something&attr2.specified=false}
...
public class GodCriteria implements Serializable, Criteria {
    ...
    public GodCriteria(GodCriteria other) {
    ...
    @Override
    public GodCriteria copy() {
        return new GodCriteria(this);
    }
